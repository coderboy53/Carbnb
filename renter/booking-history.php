...
else
{
  ...
  $sql1 = "SELECT r.*, b.*,c.*,o.* FROM renter r INNER JOIN booking b INNER JOIN car c INNER JOIN owner o ON r.R_ID = b.RENTER_ID AND b.C_VEHICLENO = c.VEHICLE_NO AND c.O_EMAIL = o.EMAIL WHERE r.R_ID = '$rid' ORDER BY b.BOOKING_ID;";
