...
<html lang = 'en'>
  ...
  <body>
   ...
   <?php include('assets/navbar.php') ?>
     ...
     <?php $nm = mysqli_query($con,"SELECT fullname FROM renter where userId='".$_SESSION['id']."'"); ?>
     <h1>Welcome, <?php echo htmlentities($nm);?></h1>
     <div class = 'center'>
       <h3>Choose that car you dreamed about.</h3>
       <br><br>
       <div class="dropdown">
